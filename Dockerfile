FROM mppmu/cuda-julia-anaconda:cuda100-julia11-anaconda3201812
...
RUN true \
    && yum install -y \
        ...
        mesa-libGLU-devel \
    && provisioning/install-sw.sh root 6.16.00 /opt/root
...
RUN yum install -y \
    ...
    && rpm -ihv https://github.com/atom/atom/releases/download/v1.34.0/atom.x86_64.rpm
